...
class RiotAuth:
	...
	async def authorize(
		...
		async with aiohttp.ClientSession(
			...
			if not username and not password:
				RiotAuth.load_cookies(self=session)
	...
	async def reauthorize(self) -> bool:
		...
		try:
			...
			return True
		except RiotAuthError:  # because credentials are empty
			return False
